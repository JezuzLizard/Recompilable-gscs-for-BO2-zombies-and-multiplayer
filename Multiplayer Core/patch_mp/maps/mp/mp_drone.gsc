...
main() //checked changed to match cerberus output
{
	...
	spawncollision( "collision_clip_128x128x10", "collider", ( 33.5, -1386.25, 211.5 ), vectorScale( ( 0, 0, -1 ), 90 ) );
	spawncollision( "collision_physics_wall_256x256x10", "collider", ( -923.5, 2180, 366.5 ), vectorScale( ( 0, 1, 0 ), 270 ) );
	spawncollision( "collision_physics_wall_256x256x10", "collider", ( -1050.5, 2303, 366.5 ), vectorScale( ( 0, 1, 0 ), 180 ) );
	spawncollision( "collision_physics_wall_256x256x10", "collider", ( -1306.5, 2303, 366.5 ), vectorScale( ( 0, 1, 0 ), 180 ) );
...
geo_changes() //checked changed to match cerberus output
{
