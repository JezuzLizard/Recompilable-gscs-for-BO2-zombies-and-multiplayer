...
main() //checked did not match cerberus output did not change
{
	...
	spawncollision( "collision_clip_wall_128x128x10", "collider", ( -2250.5, -837.5, 422.5 ), ( 0, 1, 0 ) );
	spawncollision( "collision_clip_wall_128x128x10", "collider", ( -2333, -837.5, 422.5 ), ( 0, 1, 0 ) );
	spawncollision( "collision_physics_64x64x10", "collider", ( -663.5, -1975.5, 314 ), ( 0, 1, 0 ) );
	spawncollision( "collision_clip_wall_128x128x10", "collider", ( 791.5, 683.5, 234 ), vectorScale( ( 0, 1, 0 ), 270 ) );
	...
	pipe1.angles = vectorScale( ( 0, 1, 0 ), 90 );
...
levelspawndvars( reset_dvars ) //checked did not match cerberus output did not change
{
