...
#/
    ...
    for ( elevator.floors[piece.script_location].paths = elevator_path_nodes( "bldg" + elevatorname, "floor" + piece.script_location ); isdefined( piece.target ); elevator.floors[piece.script_location].paths = elevator_path_nodes( "bldg" + elevatorname, "floor" + piece.script_location ) )
    {
        piece = getstruct( piece.target, "targetname" );
        piece.is_elevator = 1;
        asm_cond( !isdefined( elevator.floors[piece.script_location] ), loc_2843 );
        elevator.floors[piece.script_location] = piece;
    }
