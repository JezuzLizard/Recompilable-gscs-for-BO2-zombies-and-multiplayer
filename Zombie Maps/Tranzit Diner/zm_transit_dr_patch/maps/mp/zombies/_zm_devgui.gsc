...
devgui_add_weapon_entry( hint, up, weapon_name )
{
/#
	uppath = "/" + up;
	if ( up.size < 1 )
	...
	cmd = "devgui_cmd "Zombies:1/Weapons:10/" + hint + uppath + "" "set zombie_devgui_gun " + weapon_name + "" \n";
	adddebugcommand( cmd );
#/
}

devgui_add_weapon_and_attachments( hint, up, weapon_name )
{
/#
	devgui_add_weapon_entry( hint, up, weapon_name );
#/
...
/#
	...
	if ( isDefined( level.devgui_weapons_added ) && level.devgui_weapons_added > 34 )
	{
		return;
	}
