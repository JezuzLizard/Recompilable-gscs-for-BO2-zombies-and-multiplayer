...
reference_anims_from_animtree()
{
	...
	dummy_anim_ref = %ai_zombie_dog_traverse_car;
	dummy_anim_ref = %ai_zombie_dog_traverse_car_pass_to_driver;
	...
	dummy_anim_ref = %zombie_dog_traverse_down_127;
	dummy_anim_ref = %zombie_dog_traverse_up_127;
}
...
precache( ai_index )
{
	...
	precacheanimstatedef( ai_index, -1, "zm_transit_dog" );
