...
main() //checked changed to match cerberus output
{
	...
	spawncollision( "collision_physics_wall_256x256x10", "collider", ( 216.5, 4526.5, -86 ), vectorScale( ( 0, 1, 0 ), 270 ) );
	...
	spawncollision( "collision_clip_64x64x10", "collider", ( 348.5, 615, 24 ), vectorScale( ( 0, 0, 1 ), 90 ) );
	spawncollision( "collision_clip_wall_64x64x10", "collider", ( 1005.5, 1466, 173 ), vectorScale( ( 0, 1, 0 ), 270 ) );
	spawncollision( "collision_clip_wall_128x128x10", "collider", ( 808, -1434.5, -120 ), ( 0, 0, 0 ) );
	spawncollision( "collision_physics_wall_64x64x10", "collider", ( 1266, 1873.5, 86 ), vectorScale( ( 0, 1, 0 ), 35 ) );
	spawncollision( "collision_physics_wall_64x64x10", "collider", ( 1266, 1873.5, 126 ), vectorScale( ( 0, 1, 0 ), 35 ) );
