...
main() //checked changed to match cerberus output
{
	...
	spawncollision( "collision_clip_128x128x128", "collider", ( -17402.5, 2804, -109 ), vectorScale( ( 0, 1, 0 ), 315 ) );
	spawncollision( "collision_clip_128x128x128", "collider", ( -17350.5, 2856, -109 ), vectorScale( ( 0, 1, 0 ), 315 ) );
	...
	spawncollision( "collision_physics_wall_32x32x10", "collider", ( -19469, 355, -86 ), vectorScale( ( 0, 1, 0 ), 90 ) );
	spawncollision( "collision_physics_wall_32x32x10", "collider", ( -19469, 338, -86 ), vectorScale( ( 0, 1, 0 ), 90 ) );
	...
	spawncollision( "collision_tvs_anchor_desk01", "collider", ( -15441, 3711, -192 ), vectorScale( ( 0, 1, 0 ), 270 ) );
...
car_sound_think() //checked matches cerberus output
{
