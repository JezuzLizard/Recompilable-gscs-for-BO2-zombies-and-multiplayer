...
main()
{
	...
	spawncollision( "collision_clip_128x128x128", "collider", ( -17402,5, 2804, -109 ), vectorScale( ( 0, 0, 0 ), 315 ) );
	spawncollision( "collision_clip_128x128x128", "collider", ( -17350,5, 2856, -109 ), vectorScale( ( 0, 0, 0 ), 315 ) );
	...
	spawncollision( "collision_physics_wall_32x32x10", "collider", ( -19469, 355, -86 ), vectorScale( ( 0, 0, 0 ), 90 ) );
	spawncollision( "collision_physics_wall_32x32x10", "collider", ( -19469, 338, -86 ), vectorScale( ( 0, 0, 0 ), 90 ) );
	spawncollision( "collision_clip_wall_64x64x10", "collider", ( -18273,5, 1092,5, -2,5 ), vectorScale( ( 0, 0, 0 ), 86,7 ) );
	...
	spawncollision( "collision_tvs_anchor_desk01", "collider", ( -15441, 3711, -192 ), vectorScale( ( 0, 0, 0 ), 270 ) );
	spawncollision( "collision_missile_128x128x10", "collider", ( -16938,5, 2314, -226,5 ), vectorScale( ( 0, 0, 0 ), 33,5 ) );
	...
	spawncollision( "collision_physics_wall_64x64x10", "collider", ( -18712,5, 525, -122,5 ), vectorScale( ( 0, 0, 0 ), 20,9 ) );
	spawncollision( "collision_physics_wall_64x64x10", "collider", ( -18712,5, 525, -159,5 ), vectorScale( ( 0, 0, 0 ), 20,9 ) );
	spawncollision( "collision_physics_wall_64x64x10", "collider", ( -18927,5, 1099, -122,5 ), vectorScale( ( 0, 0, 0 ), 65,6 ) );
	spawncollision( "collision_physics_wall_64x64x10", "collider", ( -18927,5, 1099, -159,5 ), vectorScale( ( 0, 0, 0 ), 65,6 ) );
