...
main()
{
	...
	spawncollision( "collision_physics_128x128x10", "collider", ( -1248, -32, 285 ), ( 0, 0, 1 ) );
	spawncollision( "collision_physics_128x128x10", "collider", ( -1248, 96, 285 ), ( 0, 0, 1 ) );
	...
	spawncollision( "collision_physics_128x128x10", "collider", ( -1252, -199, 283 ), ( 0, 0, 1 ) );
	spawncollision( "collision_physics_128x128x10", "collider", ( -1252, 376, 283 ), ( 0, 0, 1 ) );
	spawncollision( "collision_physics_128x128x128", "collider", ( -158, -592, 675 ), ( 0, 0, 1 ) );
	...
	spawncollision( "collision_physics_cylinder_32x128", "collider", ( 431, -1160, 124 ), vectorScale( ( 0, 0, 1 ), 51 ) );
	...
	spawncollision( "collision_physics_cylinder_32x128", "collider", ( -1603, 1260, 135 ), vectorScale( ( 0, 0, 1 ), 51 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( -1602, 1115, 161 ), ( 0, 0, 1 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( -1602, 1276, 161 ), ( 0, 0, 1 ) );
	spawncollision( "collision_physics_64x64x64", "collider", ( -119, -752, 436 ), ( 0, 0, 1 ) );
	metalpiece = spawn( "script_model", ( -121, -757, 467 ) );
	metalpiece.angles = vectorScale( ( 0, 0, 1 ), 90 );
	...
	board1.angles = vectorScale( ( 0, 0, 1 ), 270 );
	...
	spawncollision( "collision_physics_64x64x64", "collider", ( -699, -1267, -19 ), ( 0, 0, 1 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( -683, -1219, -19 ), ( 0, 0, 1 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( -683, -1162, -24 ), ( 0, 0, 1 ) );
	spawncollision( "collision_physics_wall_512x512x10", "collider", ( -1746, 1555, -213 ), vectorScale( ( 0, 0, 1 ), 270 ) );
	spawncollision( "collision_physics_wall_256x256x10", "collider", ( -1658, 1899, -93 ), vectorScale( ( 0, 0, 1 ), 225,6 ) );
	spawncollision( "collision_physics_wall_256x256x10", "collider", ( -1570, 1989, -93 ), vectorScale( ( 0, 0, 1 ), 225,6 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( 1375, -737, 81,5 ), vectorScale( ( 0, 0, 1 ), 327,3 ) );
	...
	spawncollision( "collision_physics_wall_64x64x10", "collider", ( 918, -728, 312 ), ( 0, 0, 1 ) );
	spawncollision( "collision_physics_wall_64x64x10", "collider", ( 1962, -1303, 10,5 ), vectorScale( ( 0, 0, 1 ), 45,2 ) );
