...
main() //checked changed to match cerberus output
{
	...
	spawncollision( "collision_clip_wall_32x32x10", "collider", ( -473, -2482, 412 ), vectorScale( ( 0, 0, 1 ), 14 ) );
	spawncollision( "collision_physics_wall_32x32x10", "collider", ( -473, -2482, 412 ), vectorScale( ( 0, 0, 1 ), 14 ) );
...
killstreak_init() //checked matches cerberus output
{
