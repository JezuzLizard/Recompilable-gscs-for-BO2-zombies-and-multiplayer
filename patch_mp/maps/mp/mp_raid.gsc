...
main()
{
	...
	spawncollision( "collision_physics_64x64x64", "collider", ( 2664, 3832, 24 ), ( 0, 0, 1 ) );
	spawncollision( "collision_physics_64x64x64", "collider", ( 4127, 3741, 130 ), vectorScale( ( 0, 0, 1 ), 25,4 ) );
	...
	spawncollision( "collision_physics_128x128x10", "collider", ( 3562, 3271,5, 186,5 ), vectorScale( ( 0, 0, 1 ), 11,2 ) );
	spawncollision( "collision_missile_32x32x128", "collider", ( 3259,5, 2294,5, 230 ), ( 0, 22,8, 90 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( 1583,5, 2900, 137,5 ), ( 0, 0, 1 ) );
	spawncollision( "collision_nosight_wall_64x64x10", "collider", ( 2751, 4130,5, 214,5 ), vectorScale( ( 0, 0, 1 ), 270 ) );
	spawncollision( "collision_nosight_wall_64x64x10", "collider", ( 2751, 4099, 214,5 ), vectorScale( ( 0, 0, 1 ), 270 ) );
	spawncollision( "collision_clip_wall_64x64x10", "collider", ( 3819, 3475, 113 ), vectorScale( ( 0, 0, 1 ), 15 ) );
	spawncollision( "collision_clip_wall_64x64x10", "collider", ( 3819, 3598, 113 ), vectorScale( ( 0, 0, 1 ), 15 ) );
	spawncollision( "collision_clip_wall_64x64x10", "collider", ( 3570, 3834, 113 ), vectorScale( ( 0, 0, 1 ), 260 ) );
	spawncollision( "collision_clip_wall_256x256x10", "collider", ( 3352, 4688, 136 ), ( 0, 0, 1 ) );
