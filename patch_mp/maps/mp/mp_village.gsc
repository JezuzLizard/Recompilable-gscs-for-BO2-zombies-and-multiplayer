...
main() //checked changed to match cerberus output
{
	...
	spawncollision( "collision_physics_wall_128x128x10", "collider", ( 707, -812, 32 ), vectorScale( ( 0, 1, 0 ), 270 ) );
	spawncollision( "collision_physics_wall_128x128x10", "collider", ( 707, -730, 32 ), vectorScale( ( 0, 1, 0 ), 270 ) );
	spawncollision( "collision_physics_32x32x128", "collider", ( -1056, -1294, 32 ), vectorScale( ( 1, 0, 0 ), 270 ) );
	spawncollision( "collision_physics_32x32x128", "collider", ( -960, -1294, 32 ), vectorScale( ( 1, 0, 0 ), 270 ) );
	spawncollision( "collision_physics_32x32x128", "collider", ( -1057, -1294, 111 ), vectorScale( ( 1, 0, 0 ), 270 ) );
	spawncollision( "collision_physics_32x32x128", "collider", ( -964, -1294, 111 ), vectorScale( ( 1, 0, 0 ), 270 ) );
	...
	spawncollision( "collision_physics_32x32x128", "collider", ( 523, -1672, 2 ), vectorScale( ( 1, 0, 0 ), 270 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( -1861, -1004, 239 ), vectorScale( ( 0, 1, 0 ), 346 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( -1867, -1023, 239 ), vectorScale( ( 0, 1, 0 ), 346 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( -1861, -1324, 239 ), vectorScale( ( 0, 1, 0 ), 346 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( -1867, -1343, 239 ), vectorScale( ( 0, 1, 0 ), 346 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( -1876, -1400, 239 ), vectorScale( ( 0, 1, 0 ), 61 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( -1859, -1411, 239 ), vectorScale( ( 0, 1, 0 ), 61 ) );
	spawncollision( "collision_physics_32x32x128", "collider", ( 1335, 1029, 55 ), vectorScale( ( 1, 0, 0 ), 270 ) );
...
death_sound_think() //checked matches cerberus output
{
