...
main()
{
	...
	spawncollision( "collision_physics_32x32x32", "collider", ( 610, -126, 60 ), vectorScale( ( 0, 0, 1 ), 287,2 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( 590, -126, 67 ), vectorScale( ( 0, 0, 1 ), 287,2 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( 602, -233, 70 ), ( 0, 0, 1 ) );
	spawncollision( "collision_physics_wall_128x128x10", "collider", ( 707, -812, 32 ), vectorScale( ( 0, 0, 1 ), 270 ) );
	spawncollision( "collision_physics_wall_128x128x10", "collider", ( 707, -730, 32 ), vectorScale( ( 0, 0, 1 ), 270 ) );
	spawncollision( "collision_physics_32x32x128", "collider", ( -1056, -1294, 32 ), vectorScale( ( 0, 0, 1 ), 270 ) );
	spawncollision( "collision_physics_32x32x128", "collider", ( -960, -1294, 32 ), vectorScale( ( 0, 0, 1 ), 270 ) );
	spawncollision( "collision_physics_32x32x128", "collider", ( -1057, -1294, 111 ), vectorScale( ( 0, 0, 1 ), 270 ) );
	spawncollision( "collision_physics_32x32x128", "collider", ( -964, -1294, 111 ), vectorScale( ( 0, 0, 1 ), 270 ) );
	...
	spawncollision( "collision_physics_32x32x32", "collider", ( -1335,5, -1667, 196 ), ( 0, 0, 1 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( -1335,5, -1676, 196 ), ( 0, 0, 1 ) );
	metalsheet1 = spawn( "script_model", ( -1487, 1156, 10 ) );
	metalsheet1.angles = vectorScale( ( 0, 0, 1 ), 90 );
	...
	metalsheet1.angles = vectorScale( ( 0, 0, 1 ), 90 );
	metalsheet1 setmodel( "afr_corrugated_metal8x8" );
	spawncollision( "collision_physics_32x32x32", "collider", ( 1095, 1482, 31 ), ( 0, 0, 1 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( 1095, 1519, 31 ), ( 0, 0, 1 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( 1054, 1552, 68 ), ( 0, 0, 1 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( 1054, 1589, 68 ), ( 0, 0, 1 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( 1054, 1552, 39 ), ( 0, 0, 1 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( 1054, 1589, 39 ), ( 0, 0, 1 ) );
	...
	spawncollision( "collision_physics_32x32x32", "collider", ( 952,701, 1488,68, 29 ), vectorScale( ( 0, 0, 1 ), 24,6 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( 937,299, 1522,32, 29 ), vectorScale( ( 0, 0, 1 ), 24,6 ) );
	spawncollision( "collision_physics_256x256x10", "collider", ( 596, -1545, -8 ), vectorScale( ( 0, 0, 1 ), 2,2 ) );
	...
	spawncollision( "collision_physics_32x32x128", "collider", ( 523, -1672, 2 ), vectorScale( ( 0, 0, 1 ), 270 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( -1861, -1004, 239 ), vectorScale( ( 0, 0, 1 ), 346 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( -1867, -1023, 239 ), vectorScale( ( 0, 0, 1 ), 346 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( -1861, -1324, 239 ), vectorScale( ( 0, 0, 1 ), 346 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( -1867, -1343, 239 ), vectorScale( ( 0, 0, 1 ), 346 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( -1876, -1400, 239 ), vectorScale( ( 0, 0, 1 ), 61 ) );
	spawncollision( "collision_physics_32x32x32", "collider", ( -1859, -1411, 239 ), vectorScale( ( 0, 0, 1 ), 61 ) );
	spawncollision( "collision_physics_32x32x128", "collider", ( 1335, 1029, 55 ), vectorScale( ( 0, 0, 1 ), 270 ) );
	spawncollision( "collision_physics_256x256x10", "collider", ( 645, -1562, 0 ), vectorScale( ( 0, 0, 1 ), 3 ) );
